...
class RightPanel(QFrame):
    def __init__(self):
        ...
        self.single_result_container.setStyleSheet("""
            QWidget {
        ...
        lbl_single_title.setStyleSheet("font-size: 16px; font-weight: bold; color: #4CAF50; margin-bottom: 5px;")
        ...
        self.lbl_score_huge.setStyleSheet("font-size: 48px; font-weight: bold; color: #fff;")
        ...
        self.lbl_correct_count.setStyleSheet("font-size: 14px; color: #ccc;")
        ...
        self.lbl_sbd.setStyleSheet("font-size: 14px; font-weight: bold; color: #ddd;")
        ...
        self.lbl_made.setStyleSheet("font-size: 14px; font-weight: bold; color: #ddd;")
        ...
        self.lbl_notes.setStyleSheet("font-size: 13px; color: #F44336; font-style: italic;")
        ...
        # --- DASHBOARD UI (BATCH) ---
        lbl_dash = QLabel("📊 THỐNG KÊ REAL-TIME")
        lbl_dash.setStyleSheet("font-size: 16px; font-weight: bold; color: #4CAF50; margin-bottom: 10px;")
        lbl_dash.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.addWidget(lbl_dash)
        
        self.lbl_total = QLabel("Số bài đã chấm: 0")
        self.lbl_total.setStyleSheet("font-size: 14px; font-weight: bold; color: #ddd; padding: 5px 0;")
        layout.addWidget(self.lbl_total)
        
        self.lbl_avg = QLabel("Điểm trung bình: 0.0")
        self.lbl_avg.setStyleSheet("font-size: 14px; font-weight: bold; color: #ddd; padding: 5px 0;")
        layout.addWidget(self.lbl_avg)
        
        # Phổ điểm
        lbl_pho = QLabel("Phân bố phổ điểm:")
        lbl_pho.setStyleSheet("font-weight: bold; color: #aaa; margin-top: 15px; margin-bottom: 5px;")
        ...
        for key, color in categories:
            ...
            bar.setStyleSheet(f"QProgressBar::chunk {{ background-color: {color}; border-radius: 4px; }} QProgressBar {{ border: none; background-color: #333; border-radius: 4px; }}")
            bar.setMaximum(100)
            bar.setValue(0)
    ...
    def update_single_result(self, score: dict):
        ...
        self.single_result_container.setStyleSheet(f"""
            QWidget {{
                background-color: #2a2e39;
                border-radius: 8px;
        ...
        """)
        self.lbl_score_huge.setStyleSheet(f"font-size: 48px; font-weight: bold; color: {color};")
