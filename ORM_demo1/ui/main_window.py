...
class MainWindow(QMainWindow):
    ...
    def set_io_enabled(self, enabled: bool):
        ...
        if hasattr(self, 'toolbar_component'):
            self.toolbar_component.action_save.setEnabled(enabled)
            self.toolbar_component.action_save_as.setEnabled(enabled)
            self.toolbar_component.action_save_all.setEnabled(enabled)
